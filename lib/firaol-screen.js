    ...
    return [
      ...
      css`
        ...
        h1 {
          ...
          text-align: center;
          color: #cfd9ff;
          text-shadow: 0 0 10px #7f9fff, 0 0 20px #4f6fff;
          letter-spacing: 2px;
    ...
    return html`
      <div class="pattern">
       <div class="sky">
        ...
        <div class="title">
           <h1>HAX Club, MEETS EVERY MONDAY</h1>
           <h1>AG Engineering Bld rm 121</h1>
      </div>
        <div class="date-card">
        <date-card month="October" date="13" day="Monday" title="HAX Talk- BTOPRO 7PM" end-time="8PM" location="AG Engineering Bld rm 102" border-spacing="20" accent-color="blue"></date-card>
        <date-card month="October" date="20" day="Monday" title="HAX Meeting 7pm" end-time="6PM" location="AG Engineering Bld rm 102" border-spacing="20" accent-color="blue"></date-card>
        <date-card month="October" date="25" day="Saturday" title="HACK PSU All Day" end-time="6PM" location="ECoRE Building" border-spacing="20" accent-color="blue"></date-card>
        </div>
